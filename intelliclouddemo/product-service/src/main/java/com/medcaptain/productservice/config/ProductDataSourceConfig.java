package com.medcaptain.productservice.config;
...
public class ProductDataSourceConfig {
    ...
    private static final String Entity_Package = "com.medcaptain.productservice.entity";

    private static final String TYPEHANDER_PACKAGE = "com.medcaptain.productservice.typehandler";
    ...
    public SqlSessionFactory webPageSqlSessionFactory(@Qualifier("userDataSource") DataSource userDataSource)
        ...
        sessionFactory.setTypeHandlersPackage(TYPEHANDER_PACKAGE);
