...
public class MyStorageClient extends StorageClient {
  ...
  static public byte split_file_id(String file_id, String[] results) {
   ...
   * return null if fail
   */
  public String upload_file1(int code ,String local_filename, String file_ext_name,
                             NameValuePair[] meta_list) throws IOException, MyException {
    String parts[] = this.upload_file(code,local_filename, file_ext_name, meta_list);
    if (parts != null) {
   ...
   * return null if fail
   */
  public String upload_file1(int code,String group_name, String local_filename, String file_ext_name,
                             NameValuePair[] meta_list) throws IOException, MyException {
    String parts[] = this.upload_file(code,group_name, local_filename, file_ext_name, meta_list);
    if (parts != null) {
      return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
    } else {
      return null;
   ...
   * return null if fail
   */
  public String upload_file1(int code,byte[] file_buff, String file_ext_name,
                             NameValuePair[] meta_list) throws IOException, MyException {
    String parts[] = this.upload_file(code,file_buff, file_ext_name, meta_list);
    if (parts != null) {
      return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
    } else {
      return null;
   ...
   * return null if fail
   */
  public String upload_file1(int code,String group_name, byte[] file_buff, String file_ext_name,
                             NameValuePair[] meta_list) throws IOException, MyException {
    String parts[] = this.upload_file(code,group_name, file_buff, file_ext_name, meta_list);
    if (parts != null) {
      return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
    } else {
      return null;
   ...
   * return null if fail
   */
  public String upload_file1(int code, String group_name, long file_size,
                             UploadCallback callback, String file_ext_name,
                             NameValuePair[] meta_list) throws IOException, MyException {
    String parts[] = this.upload_file(code,group_name, file_size, callback, file_ext_name, meta_list);
    if (parts != null) {
      return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
    } else {
      return null;
   ...
   * return null if fail
   */
  public String upload_appender_file1(int code,byte[] file_buff, String file_ext_name,
                                      NameValuePair[] meta_list) throws IOException, MyException {
    String parts[] = this.upload_appender_file(code,file_buff, file_ext_name, meta_list);
    if (parts != null) {
      return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
    } else {
      return null;
   ...
   * return null if fail
   */
  public String upload_appender_file1(int code,String group_name, byte[] file_buff, String file_ext_name,
                                      NameValuePair[] meta_list) throws IOException, MyException {
    String parts[] = this.upload_appender_file(code,group_name, file_buff, file_ext_name, meta_list);
    if (parts != null) {
      return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
    } else {
      return null;
   ...
   * return null if fail
   */
  public String upload_appender_file1(int code,String group_name, long file_size,
                                      UploadCallback callback, String file_ext_name,
                                      NameValuePair[] meta_list) throws IOException, MyException {
    String parts[] = this.upload_appender_file(code,group_name, file_size, callback, file_ext_name, meta_list);
    if (parts != null) {
      return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
    } else {
      return null;
   ...
   * return null if fail
   */
  public String upload_file1(int code,String master_file_id, String prefix_name,
    ...
    parts = this.upload_file(code,parts[0], parts[1], prefix_name,
  ...
  public String upload_file1(int code,String master_file_id, String prefix_name,
    ...
    parts = this.upload_file(code,parts[0], parts[1], prefix_name, file_buff, file_ext_name, meta_list);
    if (parts != null) {
      return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
    } else {
      return null;
  ...
  public String upload_file1(int code,String master_file_id, String prefix_name,
    ...
    parts = this.upload_file(code,parts[0], parts[1], prefix_name, file_buff,
   ...
   * return null if fail
   */
  public String upload_file1(int code,String master_file_id, String prefix_name, long file_size,
                             UploadCallback callback, String file_ext_name,
                             NameValuePair[] meta_list) throws IOException, MyException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(master_file_id, parts);
    ...
    parts = this.upload_file(code,parts[0], parts[1], prefix_name, file_size, callback, file_ext_name, meta_list);
    if (parts != null) {
      return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
    } else {
      return null;
