...
package com.medcaptain.fastdfs.client.master;



import com.medcaptain.fastdfs.client.common.Base64;
...
public class StorageClient {
   ...
   * return null if fail
   */
  public String[] upload_file(int code,String local_filename, String file_ext_name,
                              NameValuePair[] meta_list) throws IOException, MyException {
    final String group_name = null;
    return this.upload_file(code,group_name, local_filename, file_ext_name, meta_list);
  }
   ...
   * return null if fail
   */
  protected String[] upload_file(int code,String group_name, String local_filename, String file_ext_name,
                                 NameValuePair[] meta_list) throws IOException, MyException {
    final byte cmd = ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_FILE;
    return this.upload_file(code,cmd, group_name, local_filename, file_ext_name, meta_list);
  }
   ...
   * return null if fail
   */
  protected String[] upload_file(int code,byte cmd, String group_name, String local_filename, String file_ext_name,
                                 NameValuePair[] meta_list) throws IOException, MyException {
    ...
    try {
      return this.do_upload_file(code, cmd, group_name, null, null, file_ext_name,
   ...
   * return null if fail
   */
  public String[] upload_file(int code,byte[] file_buff, int offset, int length, String file_ext_name,
                              NameValuePair[] meta_list) throws IOException, MyException {
    final String group_name = null;
    return this.upload_file(code,group_name, file_buff, offset, length, file_ext_name, meta_list);
  }
   ...
   * return null if fail
   */
  public String[] upload_file(int code,String group_name, byte[] file_buff, int offset, int length,
                              String file_ext_name, NameValuePair[] meta_list) throws IOException, MyException {
    return this.do_upload_file(code, ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_FILE, group_name, null, null, file_ext_name,
   ...
   * return null if fail
   */
  public String[] upload_file(int code, byte[] file_buff, String file_ext_name,
                              NameValuePair[] meta_list) throws IOException, MyException {
    final String group_name = null;
    return this.upload_file(code, group_name, file_buff, 0, file_buff.length, file_ext_name, meta_list);
  }
   ...
   * return null if fail
   */
  public String[] upload_file(int code,String group_name, byte[] file_buff,
                              String file_ext_name, NameValuePair[] meta_list) throws IOException, MyException {
    return this.do_upload_file(code, ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_FILE, group_name, null, null, file_ext_name,
   ...
   * return null if fail
   */
  public String[] upload_file(int code,String group_name, long file_size, UploadCallback callback,
                              String file_ext_name, NameValuePair[] meta_list) throws IOException, MyException {
    final String master_filename = null;
    final String prefix_name = null;

    return this.do_upload_file(code,ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_FILE, group_name, master_filename, prefix_name,
   ...
   * return null if fail
   */
  public String[] upload_file(int code,String group_name, String master_filename, String prefix_name,
    ...
    try {
      return this.do_upload_file(code,ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_SLAVE_FILE, group_name, master_filename, prefix_name,
   ...
   * return null if fail
   */
  public String[] upload_file(int code,String group_name, String master_filename,
   ...
   * return null if fail
   */
  public String[] upload_appender_file(int code,byte[] file_buff, int offset, int length, String file_ext_name,
                                       NameValuePair[] meta_list) throws IOException, MyException {
    final String group_name = null;
    return this.upload_appender_file(code,group_name, file_buff, offset, length, file_ext_name, meta_list);
  }
   ...
   * return null if fail
   */
  public String[] upload_appender_file(int code,String group_name, byte[] file_buff, int offset, int length,
                                       String file_ext_name, NameValuePair[] meta_list) throws IOException, MyException {
    return this.do_upload_file(code,ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_APPENDER_FILE, group_name, null, null, file_ext_name,
      length, new UploadBuff(file_buff, offset, length), meta_list);
  }
   ...
   * return null if fail
   */
  public String[] upload_appender_file(int code,byte[] file_buff, String file_ext_name,
                                       NameValuePair[] meta_list) throws IOException, MyException {
    final String group_name = null;
    return this.upload_appender_file(code,group_name, file_buff, 0, file_buff.length, file_ext_name, meta_list);
  }
   ...
   * return null if fail
   */
  public String[] upload_appender_file(int code,String group_name, byte[] file_buff,
                                       String file_ext_name, NameValuePair[] meta_list) throws IOException, MyException {
    return this.do_upload_file(code,ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_APPENDER_FILE, group_name, null, null, file_ext_name,
      file_buff.length, new UploadBuff(file_buff, 0, file_buff.length), meta_list);
  }
   ...
   * return null if fail
   */
  public String[] upload_appender_file(int code,String group_name, long file_size, UploadCallback callback,
                                       String file_ext_name, NameValuePair[] meta_list) throws IOException, MyException {
    final String master_filename = null;
    final String prefix_name = null;

    return this.do_upload_file(code,ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_APPENDER_FILE, group_name, master_filename, prefix_name,
      file_ext_name, file_size, callback, meta_list);
  }
   ...
   * return null if fail
   */
  protected String[] do_upload_file(int code,byte cmd, String group_name, String master_filename,
