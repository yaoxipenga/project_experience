...
public class FileDataSourceConfig {
    ...
    private static final String Entity_Package = "com.medcaptain.file.entity";

    private static final String HANDLERS_PACKAGE = "com.medcaptain.file.typehandler";
    ...
    public SqlSessionFactory webPageSqlSessionFactory(@Qualifier("userDataSource") DataSource userDataSource)
        ...
        sessionFactory.setTypeHandlersPackage(HANDLERS_PACKAGE);
