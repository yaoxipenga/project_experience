...
import com.medcaptain.utils.algorithmImpl.FileTypeImpl;
import com.medcaptain.utils.algorithmImpl.FileImpl;
...
public final class FileUtil {
    ...
    public static String readContent(InputStream inputStream) {
        try {
            ...
            byte[] contentBytes = new byte[10240];
            int readLength;
            while ((readLength = inputStream.read(contentBytes)) > 0) {
